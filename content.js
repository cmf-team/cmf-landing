...
// All editable copy & data lives here as DEFAULT_CONTENT. At runtime the store
// merges any saved overrides from localStorage. The admin panel mutates the
// store; everything persists automatically and can be exported/imported.
...
const DEFAULT_CONTENT = {
  brand: { abbr: 'CMF', name: 'Center of Mathematical Finance', sub: 'Center of Mathematical Finance' },
  nav: {
    applyLabel: 'Apply',
    links: [
      { label: 'Home', href: '#/' },
  ...
  home: {
    hero: {
      eyebrow: 'IMPACT-DRIVEN · INTERNATIONAL · TUITION-FREE',
      headline: 'Center of\nMathematical\nFinance',
      subhead: 'From financial intuition to rigorous quantitative modeling',
      paragraph: 'CMF is an impact-driven international educational initiative for people with high ethical values and strong technical skills. Across our schools in Quantitative Finance, HFT, Options, AI, FinTech and Web3, we support talented individuals — especially from developing countries — to start meaningful careers and contribute to real-world research.',
      cta1: 'Explore Programs',
      cta2: 'View Portfolio',
    },
    about: {
      eyebrow: '/ 01 — Our approach',
      heading: 'Ethics, skill and\nreal-world impact.',
      lede: 'A community where practitioners with 10+ years of experience build and execute real projects alongside exceptionally strong students. The only investment we ask for is your time and commitment.',
      values: [
        { icon: 'rigor', title: 'Rigorous', body: 'From financial intuition to rigorous quantitative modeling — stochastic calculus, numerical methods and the depth required to read papers, not just recite them.' },
        { icon: 'practice', title: 'Builder-first', body: 'We learn by building. Backtesters, pricing engines, AI agents and live trading systems — every program ships real artifacts on real data.' },
        { icon: 'intuition', title: 'Impact-driven', body: 'Tuition-free programs for talented people across the world — especially from developing countries — unlocking meaningful careers in democratic societies.' },
      ],
    },
    programsSec: {
      eyebrow: '/ 02 — Schools',
      heading: 'Programs open\nfor registration.',
      lede: 'Four flagship schools, each delivered as two intensive courses. FinTech, Equity Research and the AI & Web3 Startup Incubator open separately — see all programs for the full list.',
      allLabel: 'View all schools',
    },
    portfolioSec: {
      eyebrow: '/ 03 — Portfolio',
      heading: 'Projects by our\nteam and cohorts.',
      lede: 'Capstone work and ongoing research across CMF schools. Every project ships with documentation, code and a written defense — built collaboratively by students and practitioner mentors.',
    },
    stats: [
      { num: '07', gold: true, label: 'Schools & programs' },
      { num: '10+ yrs', gold: false, label: 'Avg. mentor experience' },
      { num: 'Google · GS', gold: false, label: 'Where alumni land' },
      { num: '100%', gold: true, label: 'Tuition-free' },
    ],
    testimonialsSec: {
      eyebrow: '/ 04 — Voices',
      heading: 'From our alumni\nand partners.',
      items: [
        { quote: 'It is rare to find a team where practitioners with 10+ years of experience work together to build real-world projects within an educational initiative — alongside exceptionally strong students.', initials: 'EK', name: 'Elena Kovač', meta: 'Options School · Mentor' },
        { quote: 'CMF rebuilt the way I read papers. Six months in I was pricing exotic barriers on the desk — and actually understanding what the Greeks were telling me.', initials: 'RT', name: 'Ravi Thakkar', meta: 'Adv. Quant Analytics · Alumnus' },
        { quote: 'Lean stack. Sharp problems. We built AI agents that actually shipped — and the evaluation criteria forced honesty about what was real and what was AI slop.', initials: 'MS', name: 'Maya Soriano', meta: 'AI School · Cohort 01' },
      ],
    },
    partners: ['GOOGLE', 'GOLDMAN SACHS', 'MCKINSEY', 'YNVRSTY', 'AI INSTITUTE', 'FINTECH SCHOOL'],
  },

  programs: [
    {
      id: 'ai', num: '01', tag: 'AI SCHOOL', icon: 'ai',
      ...
      meta: [{ k: 'Duration', v: 'Until end of July' }, { k: 'Format', v: 'Online · Saturdays' }, { k: 'Cohort', v: 'Cohort 01 · 2026' }, { k: 'Language', v: 'English' }],
      modules: [
      ...
      outcomes: ['Ship working AI agents end-to-end with a minimal stack', 'Design evaluation systems that catch synthetic output', 'Engineer prompts that behave consistently in production', 'Combine your work with the AI & Web3 Startup Incubator'],
      audience: ['AI engineers moving from research to product', 'Product builders adding LLM capability to real workflows', 'Founders and CTOs of early-stage AI startups', 'Strong technical people who want to ship, not just lecture'],
      instructors: [
    ...
    {
      id: 'options', num: '02', tag: 'OPTIONS SCHOOL', icon: 'options',
      ...
      detailTag: 'OPTIONS SCHOOL · TRACK 02',
      ...
      outcomes: ['Build and operate an institutional options backtester end-to-end', 'Calibrate pricing models for illiquid and exotic instruments', 'Extend the framework into crypto options with confidence', 'Manage vega and surface-dynamic risk at the portfolio level', 'Augment the workflow with custom AI agent orchestration'],
      audience: ['Options traders and quants seeking a rigorous, integrated framework', 'Engineers building pricing, risk or backtesting infrastructure', 'Researchers moving from academic finance to the desk', 'Crypto-options practitioners formalising their stack'],
      instructors: [
    ...
    {
      id: 'hft', num: '03', tag: 'HFT SCHOOL', icon: 'hft',
      title: 'HFT School',
      ...
      outcomes: ['Reason quantitatively about queue position and adverse selection', 'Build market-making strategy with inventory and risk controls', 'Design latency-aware systems with realistic engineering trade-offs', 'Evaluate execution research with honest, leak-free methodology'],
      audience: ['Quants moving into high-frequency systematic strategies', 'Engineers building exchange-facing trading systems', 'Researchers interested in market microstructure'],
      instructors: [
    ...
    {
      id: 'quant', num: '04', tag: 'ADV. QUANT ANALYTICS', icon: 'quant',
      ...
      detailTag: 'ADV. QUANT ANALYTICS · TRACK 04',
      ...
      meta: [{ k: 'Duration', v: '14 weeks' }, { k: 'Format', v: 'Online · Weekly' }, { k: 'Cohort', v: 'Cohort 2026' }, { k: 'Language', v: 'English' }],
      modules: [
        { num: '01', title: 'Binomial & Black–Scholes Models', tag: '2 WEEKS', desc: 'The two anchors of derivatives pricing, derived from no-arbitrage and martingale arguments.' },
        { num: '02', title: 'Greeks: Delta, Gamma, Theta, Vega', tag: '1 WEEK', desc: 'What they measure, how they trade, and why they fail — Δ, Γ, Θ, ν and their interrelationships.' },
        { num: '03', title: 'Volatility & the √T rule', tag: '1 WEEK', desc: 'Historical, implied, smile, skew and surface construction with arbitrage-free interpolation.' },
        { num: '04', title: 'Bloomberg Option Pricing & Yield Curves', tag: '1 WEEK', desc: 'Hands-on with live tickers, swap curves and vol surfaces from the desk.' },
        { num: '05', title: 'PDE Methods & Finite Differences', tag: '2 WEEKS', desc: 'The Black–Scholes equation. Implicit, explicit and Crank–Nicolson schemes in Python.' },
        { num: '06', title: 'Itô Processes, Martingales & Risk-Neutral Measure', tag: '2 WEEKS', desc: 'The machinery, end to end — through to the Fundamental Theorem of Asset Pricing.' },
        { num: '07', title: 'Feynman–Kac Lemma', tag: '1 WEEK', desc: 'The bridge between PDE and probabilistic representations of derivative prices.' },
        { num: '08', title: 'Barrier & Asian Options', tag: '2 WEEKS', desc: 'Path-dependent derivatives — up/down · in/out — and the calibration that makes them tradeable.' },
        { num: '09', title: 'Monte Carlo Pricing & Simulation', tag: '2 WEEKS', desc: 'Variance reduction, quasi-MC, and Longstaff–Schwartz for early-exercise features.' },
      ],
      outcomes: ['Price European, American and exotic options with confidence', 'Read and reproduce derivatives papers from the literature', 'Calibrate volatility surfaces and yield curves on real data', 'Build and validate Monte Carlo pricers in production code', 'Reason fluently in the language of Greeks and risk'],
      audience: ['Mathematicians and physicists moving into quant finance', 'Software engineers joining a trading or pricing team', 'Computer scientists with a strong analytical background', 'Junior quants and researchers seeking a rigorous refresher'],
      instructors: [
    ...
    {
      id: 'fintech', num: '05', tag: 'FINTECH SCHOOL', icon: 'fintech',
      title: 'FinTech Equity Analyst Program',
      desc: 'Investments in fintech, digital assets and AI in finance — lectures, expert interviews and student project presentations.',
      courses: ['Course 1 · FinTech Business Models & Universe', 'Course 2 · Data, AI & Regulation in Finance'],
      detailTag: 'FINTECH SCHOOL',
      ...
      meta: [{ k: 'Duration', v: 'Until end of June' }, { k: 'Format', v: 'Online · Sundays' }, { k: 'Cohort', v: 'Cohort 2026' }, { k: 'Language', v: 'English' }],
      modules: [
      ...
      outcomes: ['Value a fintech company from its annual report end-to-end', 'Build a thesis-driven fintech portfolio across verticals', 'Identify AI applications most likely to reshape finance', 'Communicate fintech investment ideas to investment committees'],
      audience: ['Acting and aspiring equity analysts', 'Investors wanting deeper fintech and digital-asset coverage', 'Strategy and corporate-development professionals'],
      instructors: [{ initials: 'FT', name: 'FinTech Lead', role: 'Lead Instructor', bio: 'Career equity research across fintech and digital assets.' }],
      faqs: [
  ...
  projects: [
    {
      id: 'options-backtester', title: 'Options Backtester', cohort: 'OPTIONS SCHOOL', variant: 'bars', tint: 'gold',
      tags: ['Options', 'Backtesting'],
      ...
      detailCohort: 'OPTIONS SCHOOL · CORE R&D',
      ...
      detailTags: ['Options', 'Backtesting', 'Engine'],
      duration: '2026 · Ongoing',
      team: [{ initials: 'PR', name: 'Project Lead', role: 'Product Owner' }, { initials: 'MG', name: 'Strategy Eng.', role: 'Strategy Logic' }, { initials: 'LT', name: 'Infra Eng.', role: 'Simulation Core' }, { initials: 'AB', name: 'Research', role: 'Validation' }],
      metrics: [{ v: 'Portfolio', l: 'Multi-leg support' }, { v: 'Regime-aware', l: 'Stress scenarios' }, { v: 'TCA-built-in', l: 'Realistic costs' }, { v: 'Tick-level', l: 'Granularity' }],
      problem: { title: 'The problem', paras: ['Options strategies that look attractive in a simplified backtest can fall apart under realistic execution, regime shifts and book-level risk constraints. A research-grade backtester needs to capture all three honestly.', 'Existing open-source backtesters tend to specialize: portfolio analytics without proper greek-aware execution, or single-strategy simulators without portfolio aggregation. The desk needed one engine that did both.'], chart: { variant: 'bars', label: 'Strategy PnL across stress regimes' } },
      approach: { title: 'Our approach', paras: ['A modular simulation core decouples market data, pricing, strategy logic and portfolio aggregation — each component pluggable and individually testable. Strategies are scripted as event-driven generators that react to a synchronized clock of quotes, fills and corporate actions.', 'Transaction cost modeling is first-class: spread cost, exchange fees, gamma-aware slippage and an optional impact model calibrated from execution traces. Regime sensitivity is built in via parametric scenario overlays.'], list: [{ t: 'Event-driven simulation core', d: 'Synchronized clock over quotes, fills and corporate actions.' }, { t: 'Greek-aware execution layer', d: 'Honest fills with spread, fees and impact.' }, { t: 'Portfolio aggregation', d: 'Multi-strategy, multi-underlier book accounting.' }, { t: 'Regime overlays', d: 'Stress scenarios layered on historical replay.' }], chart: { variant: 'curve', label: 'Cumulative PnL · validation strategy' } },
      results: { title: 'Results & impact', paras: ['The backtester is now the standard evaluation engine across Options School projects. New strategy ideas move from notebook to portfolio-level evaluation in under a day, with TCA and regime sensitivity built in.', 'Code is open-sourced to the CMF Team for reuse across HFT and Advanced Quant Analytics tracks.'], chart: { variant: 'heatmap', label: 'Strategy × regime sensitivity matrix' } },
    },
    {
      id: 'pricing-curve', title: 'Pricing & Curve Modeling', cohort: 'OPTIONS SCHOOL', variant: 'surface', tint: 'gold',
      ...
      detailCohort: 'OPTIONS SCHOOL · PRICING',
      ...
      detailTags: ['Options', 'Pricing', 'Calibration'],
      duration: '2026 · Ongoing',
      team: [{ initials: 'SD', name: 'Project Lead', role: 'Lead Quant' }, { initials: 'KP', name: 'Modeling', role: 'Surface Construction' }, { initials: 'BJ', name: 'Infrastructure', role: 'Calibration Engine' }],
      metrics: [{ v: 'Arb-free', l: 'Surface construction' }, { v: 'Illiquid', l: 'Specialized focus' }, { v: 'Multi-asset', l: 'Cross-product' }, { v: 'Calibrated', l: 'On real quotes' }],
      problem: { title: 'The problem', paras: ['Standard pricing pipelines assume liquid, two-sided quotes across a dense grid. Reality is sparser — wide spreads, stale prices, missing tenors and wing-only quotes that defeat naive calibration.', 'Downstream consumers — hedge engines, exotic pricers and risk dashboards — need a smooth, stable, arbitrage-free surface even when the input quote stream is messy.'], chart: { variant: 'surface', label: 'Implied vol surface · illiquid instrument' } },
      approach: { title: 'Our approach', paras: ['We layer an arbitrage-free parameterization (SSVI-style) over a constrained per-slice refinement, with bespoke quote cleaning and weighting. The wings of illiquid surfaces are stabilized using cross-product invariants — put-call parity, calendar relationships and synthetic far-strike anchors.', 'The calibration runs in milliseconds per slice with a homotopy warm-start from the previous tick, making it suitable for both research notebooks and production hedge engines.'], list: [{ t: 'Arbitrage-free skeleton', d: 'No-arb-by-construction parameterization across tenors.' }, { t: 'Sparse-quote handling', d: 'Synthetic anchors when wings are unobservable.' }, { t: 'Cross-product invariants', d: 'Parity and calendar conditions for stability.' }, { t: 'Warm-started solver', d: 'Custom Jacobians, homotopy in calibration time.' }], chart: { variant: 'curve', label: 'Slice fit · 30-day expiry · log-moneyness' } },
      results: { title: 'Results & impact', paras: ['Stable, arbitrage-free surfaces produced even on illiquid instruments where naive SVI fails. The framework is consumed by the backtester, the vega-hedging risk layer and the crypto options module — making it the pricing backbone of Options School.'], chart: { variant: 'heatmap', label: 'Calibration residuals · strikes × tenors' } },
    },
    {
      id: 'crypto-options', title: 'Crypto Options Module', cohort: 'OPTIONS SCHOOL', variant: 'orderbook', tint: 'gold',
      tags: ['Options', 'Crypto'],
      ...
      detailCohort: 'OPTIONS SCHOOL · CRYPTO',
      ...
      detailTags: ['Options', 'Crypto', 'DeFi'],
      duration: '2026 · Ongoing',
      team: [{ initials: 'ZH', name: 'Project Lead', role: 'Crypto Lead' }, { initials: 'OA', name: 'On-chain Eng.', role: 'Venue Integration' }, { initials: 'EN', name: 'Risk', role: 'Adapted Hedging' }],
      metrics: [{ v: 'Multi-venue', l: 'Centralised + on-chain' }, { v: 'Higher vol', l: 'Regime-aware' }, { v: '24/7', l: 'Continuous markets' }, { v: 'Adapted', l: 'Microstructure-aware' }],
      problem: { title: 'The problem', paras: ['Crypto options inherit the institutional toolkit but operate under very different market conditions — wider spreads, jumpier underlyings, 24/7 trading, fragmented venues and a mix of centralized and on-chain liquidity.', 'Naively porting equity-options infrastructure produces strategies that look profitable on paper but break under crypto regime shifts and execution constraints.'], chart: { variant: 'orderbook', label: 'Crypto options · order book depth' } },
      approach: { title: 'Our approach', paras: ['We re-use the same pricing, backtesting and risk infrastructure but adapt the calibration priors, regime overlays and execution layer to crypto realities — fatter tails in the implied distribution, 24/7 funding and the cross-venue dynamics of CEX and DEX liquidity.'], list: [{ t: 'Crypto-tuned priors', d: 'Fatter-tail-aware calibration for surface construction.' }, { t: 'CEX + DEX integration', d: 'Unified view across centralised and on-chain venues.' }, { t: '24/7 portfolio risk', d: 'Continuous-market risk and funding accounting.' }], chart: { variant: 'curve', label: 'Realized vs implied vol · BTC options' } },
      results: { title: 'Results & impact', paras: ['A working crypto-options stack sharing the same backtester, pricing engine and risk layer as the institutional Options School framework — closing the gap between traditional and digital-asset options research.'], chart: { variant: 'network', label: 'Cross-venue liquidity graph' } },
    },
    {
      id: 'vega-hedging', title: 'Portfolio Risk & Vega Hedging', cohort: 'OPTIONS SCHOOL', variant: 'heatmap', tint: 'gold',
      tags: ['Options', 'Risk'],
      ...
      detailCohort: 'OPTIONS SCHOOL · RISK',
      ...
      detailTags: ['Options', 'Risk', 'Hedging'],
      duration: '2026 · Ongoing',
      team: [{ initials: 'AH', name: 'Project Lead', role: 'Risk Lead' }, { initials: 'NV', name: 'Quant', role: 'Hedging Logic' }],
      metrics: [{ v: 'Vega', l: 'Primary axis' }, { v: 'Surface-aware', l: 'Bucketed hedging' }, { v: 'Portfolio', l: 'Cross-book' }, { v: 'Live', l: 'Continuously hedged' }],
    ...
    {
      id: 'ai-agent-layer', title: 'AI Agent Layer', cohort: 'AI SCHOOL · OPTIONS', variant: 'network', tint: 'gold',
      tags: ['AI', 'Agents'],
      ...
      detailCohort: 'AI SCHOOL × OPTIONS SCHOOL',
      ...
      detailTags: ['AI', 'Agents', 'Orchestration'],
      duration: '2026 · Ongoing',
      team: [{ initials: 'TB', name: 'AI Lead', role: 'AI School Lead' }, { initials: 'IL', name: 'Agent Eng.', role: 'Orchestration' }, { initials: 'KW', name: 'Eval', role: 'Behavior Framework' }],
      metrics: [{ v: 'Multi-tool', l: 'Integration engine' }, { v: 'Honest', l: 'Eval-driven design' }, { v: 'Human-feeling', l: 'No synthetic tone' }, { v: 'Production', l: 'Reliable behaviour' }],
    ...
    {
      id: 'hft-market-making', title: 'HFT Market Making', cohort: 'HFT SCHOOL', variant: 'curve', tint: 'gold',
      tags: ['HFT', 'Microstructure'],
      ...
      detailTags: ['HFT', 'Microstructure', 'Market Making'],
      duration: '2026 · Ongoing',
  ...
  pages: {
    programsIndex: { eyebrow: '/ Programs', title: 'All programs.', lede: 'Our schools span quantitative finance, HFT, options, AI, FinTech and more. Take one, stack several, or design a custom path with admissions.' },
    portfolioIndex: { eyebrow: '/ Portfolio', title: 'Projects.', lede: 'Capstone work and ongoing research from CMF cohorts.' },
    about: {
      eyebrow: '/ About CMF', title: 'Our mission.',
      lede1: 'CMF is an impact-driven international educational initiative for people with high ethical values and strong technical skills.',
      lede2: 'Our mission is to support talented individuals — especially from developing countries — to unlock their potential, start meaningful careers and contribute to research and innovation in democratic societies.',
      quote: 'It is rare to find a team where practitioners with 10+ years of experience work together to build and execute real-world projects within an educational initiative alongside exceptionally strong students.',
      quoteAttr: 'The CMF Team',
      stats: [
        { num: '12', gold: true, label: 'Schools & programs' },
        { num: '100%', gold: false, label: 'Tuition-free' },
        { num: '~20', gold: true, label: 'Hrs / month · team' },
        { num: 'Intl.', gold: false, label: 'Cohorts worldwide' },
      ],
      teamEyebrow: '/ The CMF Team', teamHeading: 'Practitioners and\nstrong students.',
      teamP1: 'It is rare to find a team where practitioners — many with 10+ years of experience — work together to build and execute real-world projects within an educational initiative alongside exceptionally strong students.',
      teamP2: 'Open roles include Product Owners on real quant, AI and Web3 projects; lecturers and TAs; mentors and founders building startups in our Business Incubator; managers across our online university (YNVRSTY) and EdTech labs.',
      infoHead: 'CMF · at a glance',
      info: [
        { k: 'Tuition', v: '100% free' }, { k: 'Commitment', v: '~20 hrs / month' }, { k: 'Mentors', v: '10+ yrs experience' },
        { k: 'Alumni at', v: 'Google · GS · McKinsey' }, { k: 'Schools', v: '9 active · 3 upcoming' }, { k: 'Initiative', v: 'YNVRSTY · CMF · AI Institute' },
      ],
      schoolsEyebrow: '/ The full curriculum', schoolsHeading: 'Twelve schools.\nOne mission.',
      schoolsLede: 'From quantitative finance to AI agents, from HFT to global macro — CMF spans the technical frontier of modern finance. Nine schools are running today; three more open in 2026.',
      schools: [
      ...
      participateEyebrow: '/ Ways to participate', participateHeading: 'Join as a student.\nOr join the team.',
      participateLede: 'We are always excited to meet ethical and technically strong people who want to participate in CMF.',
      participate: [
        { icon: 'ai', title: 'Student', body: 'Apply to a school — AI, Options, HFT, Quant, FinTech or the Startup Incubator. Build real projects with practitioner mentors.', link: 'Apply to a school →', href: '#/apply' },
        { icon: 'quant', title: 'Product Owner', body: 'Lead a small student team on a real project within Options School, HFT School or the Advanced Quantitative Analytics Program.', link: 'Join the CMF Team →', href: '#/contact' },
        { icon: 'incubator', title: 'Lecturer / Mentor', body: 'Design and deliver courses, workshops or interview-prep sessions. Share expertise and deepen your own understanding.', link: 'Get in touch →', href: '#/contact' },
      ],
      ctaEyebrow: 'Cohorts open year-round', ctaHeading: 'Ready to join?\nThe CMF mission is open.', cta1: 'Apply now', cta2: 'Talk to admissions',
    },
    contact: {
      eyebrow: '/ Contact', title: 'Get in touch.',
      lede: 'Questions about programs, partnerships or press? We respond within two business days.',
      items: [
        { k: 'Admissions', v: 'admissions@cmf.edu', href: 'mailto:admissions@cmf.edu' },
        { k: 'Partnerships', v: 'partners@cmf.edu', href: 'mailto:partners@cmf.edu' },
        { k: 'Office', v: '14 Rue de la Bourse\n75002 Paris, France', href: '' },
      ],
      formTitle: 'Send us a message', sent: 'Message sent.', sentBody: "We'll be in touch within two business days.",
    },
    apply: {
      eyebrow: '/ Apply · Cohort 2026', title: 'Apply.',
      lede: 'Three short steps. Full application reviewed within ten business days.',
      step0Title: 'Choose your track.', step0Body: 'You can change this later, or stack a second track at the next intake.',
      step1Title: 'About you.',
      doneTitle: 'Application received.', doneBody: "Thanks — you'll hear back from admissions within ten business days. Track your status by email.",
    },
  },

  footer: {
    blurb: 'An impact-driven international educational initiative for people with high ethical values and strong technical skills. Tuition-free programs supporting talented individuals, especially from developing countries.',
    social: [
      { label: 'LinkedIn', icon: 'linkedin', href: 'https://www.linkedin.com/school/cmf-ynvrsty' },
      { label: 'GitHub', icon: 'github', href: 'https://github.com/cmf-team' },
      { label: 'YouTube', icon: 'youtube', href: 'https://www.youtube.com/@CMF_YNVRSTY' },
    ],
    cols: [
      { head: 'Schools', links: [
        { label: 'AI School', href: '#/program/ai' }, { label: 'Options School', href: '#/program/options' },
        { label: 'HFT School', href: '#/program/hft' }, { label: 'Adv. Quant Analytics', href: '#/program/quant' },
        { label: 'FinTech School', href: '#/program/fintech' } ] },
      { head: 'Portfolio', links: [
        { label: 'Options Backtester', href: '#/project/options-backtester' }, { label: 'Pricing & Curves', href: '#/project/pricing-curve' },
        { label: 'AI Agent Layer', href: '#/project/ai-agent-layer' }, { label: 'All projects', href: '#/portfolio' } ] },
      { head: 'About', links: [
        { label: 'Our mission', href: '#/about' }, { label: 'CMF Team', href: '#/about' },
        { label: 'Alumni', href: '#/about' }, { label: 'YNVRSTY', href: '#/about' } ] },
      { head: 'Contact', links: [
        { label: 'admissions@cmf.edu', href: 'mailto:admissions@cmf.edu' }, { label: 'Join CMF Team', href: '#/contact' },
        { label: 'Partnerships', href: '#/contact' }, { label: 'Press', href: '#/contact' } ] },
    ],
    copyright: '© 2026 Center of Mathematical Finance. Impact-driven · International · Tuition-free.',
    version: 'v 2026.1 · Cohort active',
  },
};
...
Object.assign(window, {
  DEFAULT_CONTENT, store, AdminProvider, AdminCtx, useAdmin, useEditing, useField, useList,
